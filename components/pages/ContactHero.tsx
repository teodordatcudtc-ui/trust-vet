      ...
      <div className="container-custom relative z-10">
        ...
        >
          ...
          <p className="text-xl text-white/90 mb-8 leading-relaxed">
            Suntem aici pentru tine și animalul tău. Contactează-ne pentru programări, 
            întrebări sau în caz de urgență veterinară.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-12">
            <div className="flex flex-col items-center">
              ...
              <span className="text-sm font-medium">24/7 Urgențe</span>
            </div>
            <div className="flex flex-col items-center">
              <div className="w-16 h-16 bg-white/20 rounded-2xl flex items-center justify-center mb-3">
            ...
            <div className="flex flex-col items-center">
              ...
              <span className="text-sm font-medium">Centru București</span>
            </div>
            <div className="flex flex-col items-center">
              <div className="w-16 h-16 bg-white/20 rounded-2xl flex items-center justify-center mb-3">
                <Clock className="w-8 h-8" />
              </div>
              <span className="text-sm font-medium">Program extins</span>
            </div>
          </div>
        </motion.div>
      </div>
